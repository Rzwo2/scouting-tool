...
class MakeCrudDataTables extends AbstractMaker
{
    ...
    public function __construct(private DoctrineHelper $doctrineHelper, private Generator $generator)
    {
        $this->formTypeRenderer = new FormTypeRenderer($generator);
    ...
    {
        return 'Create CRUD for Doctrine entity class with jQuery DataTables';
    }

    public function configureCommand(Command $command, InputConfiguration $inputConfig): void
    {
        $command
            ->addArgument('entity-class', InputArgument::OPTIONAL, 'The class name of the entity to create CRUD (e.g. <fg=yellow>User</>)')
        ;
    ...
    public function interact(InputInterface $input, ConsoleStyle $io, Command $command): void
    {
        ...
        $this->controllerClassName = Str::asClassName(\sprintf('%s Controller', $input->getArgument('entity-class')));

        $this->useAjax = $io->confirm(
            'Use Ajax?',
            $this->useAjax
        );
    ...
    {
        $entityName = $input->getArgument('entity-class');
        ...
        $serviceClassDetails = $generator->createClassNameDetails(
            name: $entityName,
            namespacePrefix: "Domain\\$entityName\\",
            suffix: 'Service',
        );
        $serviceClassName = $serviceClassDetails->getShortName();
        dd($serviceClassDetails->getFullName());
        $serviceClassData = ClassData::create(
            class: ''
        );
